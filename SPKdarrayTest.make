CC = gcc
OBJS = kdarray_unit_test.o SPKDArray.o SPPoint.o SPLogger.o SPKDTree.o
...
$(EXEC): $(OBJS)
	$(CC) $(OBJS) -o $@
kdarray_unit_test.o: $(TESTS_DIR)/kdarray_unit_test.c $(TESTS_DIR)/unit_test_util.h  SPKDArray.h SPPoint.h SPKDTree.h
